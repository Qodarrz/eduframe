        ...
        <form action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-blue-500 transition">
                    ...
                    <label for="gambar" class="cursor-pointer">
                        ...
                        <div id="upload-placeholder">
                            ...
                            <p class="text-gray-600 font-semibold mb-1">Klik untuk upload gambar</p>
            ...
            <div class="mb-6">
                ...
                <select name="kategori" id="kategori" required 
                    ...
                    <option value="ditemukan" {{ old('kategori') == 'ditemukan' ? 'selected' : '' }}>Ditemukan</option>
            ...
            <div id="lokasiTerakhirField" class="mb-6" style="display: none;">
                ...
                <input type="text" name="lokasi_terakhir" id="lokasi_terakhir" value="{{ old('lokasi_terakhir') }}" 
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
...
// Trigger change event on page load if kategori has value
