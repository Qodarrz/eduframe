...
@section('page-subtitle', 'Buat informasi atau pengumuman baru')
        ...
        <form action="{{ route('informasi.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <select name="tipe" id="tipe" required 
                    ...
                    <option value="sejarah" {{ old('tipe') == 'sejarah' ? 'selected' : '' }}>📜 Sejarah</option>
            ...
            <div class="mb-6">
                ...
                <textarea name="konten" id="konten" rows="10" required 
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="Tulis konten informasi lengkap di sini...">{{ old('konten') }}</textarea>
            </div>
